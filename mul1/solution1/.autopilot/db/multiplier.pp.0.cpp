# 1 "Downloads/hls/multi/multiplier.cpp"
# 1 "Downloads/hls/multi/multiplier.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "Downloads/hls/multi/multiplier.cpp" 2
...
# 2 "Downloads/hls/multi/multiplier.cpp" 2
# 1 "Downloads/hls/multi/header.h" 1
typedef int din;
typedef long long dout;

void multi(din A,din B,dout *C);
# 3 "Downloads/hls/multi/multiplier.cpp" 2
typedef int din;
typedef long long dout;
void multi(din A,din B,dout *C);
*C=A*B;
