...
#define AUTOTB_TVIN_start_r "../tv/cdatafile/c.timer.autotvin_start_r.dat"
#define AUTOTB_TVOUT_start_r "../tv/cdatafile/c.timer.autotvout_start_r.dat"
#define AUTOTB_TVIN_end_r "../tv/cdatafile/c.timer.autotvin_end_r.dat"
#define AUTOTB_TVOUT_end_r "../tv/cdatafile/c.timer.autotvout_end_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_end_r "../tv/rtldatafile/rtl.timer.autotvout_end_r.dat"
...
extern "C"
void timer_hw_stub_wrapper(hls::sim::Byte<2>*, hls::sim::Byte<1>, void*);

extern "C"
void apatb_timer_hw(hls::sim::Byte<2>* __xlx_apatb_param_n, hls::sim::Byte<1> __xlx_apatb_param_start_r, void* __xlx_apatb_param_end_r)
{
  ...
  static hls::sim::Register port2 {
    ...
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_end_r),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_end_r),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_end_r),
#endif
  };
  port2.param = __xlx_apatb_param_end_r;
  ...
  try {
    ...
    timer_hw_stub_wrapper(__xlx_apatb_param_n, __xlx_apatb_param_start_r, __xlx_apatb_param_end_r);
