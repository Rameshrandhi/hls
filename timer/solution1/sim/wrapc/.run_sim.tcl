...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "timer.autotvin.dat"
	set constFileTvOut       "timer.autotvout.dat"
	set constFileHdlTvIn     "timer.autohdltvin.dat"
	set constFileHdlTvOut    "timer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
